"""
Django settings for birdcontrol project.
...
ALLOWED_HOSTS = [
    ...
    'https://vasudev-bird-control-1-mcti.onrender.com/',
]
...
WSGI_APPLICATION = 'birdcontrol.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'zqvk upfr ixrf xkap'
